import os
from resume_checker_agent.crew import load_config, extract_resume_text, ResumeCheckerCrew
...
def run():
    ...
    tasks_config = load_config('src/resume_checker_agent/config/tasks.yaml')
